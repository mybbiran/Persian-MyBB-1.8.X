...
class installerOutput {
	 ...
	 * @var string
	 */
	public $title = "جادوگر نصب‌کننده‌ی MyBB";
...
END;
		...
		echo <<<END
			<div id="copyright" dir="ltr">
				MyBB &copy; 2002-{$copyyear} MyBB Group - Persian Translation by <a href="http://www.mybbiran.com" target="_blank">MyBBIran.com (Persian MyBB Reference) </a>
			</div>
		</div>
		</div>
		</div>
